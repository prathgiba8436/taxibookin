				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">Liên hệ chúng tôi</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									<h3>Để lại một lời nhắn @auth @else<span style="font-size:12px;" class="text-danger">[Bạn cần đăng nhập]</span>@endauth</h3>
								</div>
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-success">Gửi tin nhắn thành công...</p>
			</div>
		  </div>
		</div>
	</div>
	...
	<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-warning">Có lỗi xảy ra vui lòng thử lại.</p>
			</div>
		  </div>
		</div>
	</div>
