...
@section('title','TAXI TRAO ĐỔI || BLOG ')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Diễn đàn</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blog-single-main">
                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Đăng bình luận</span><span class="comment_btn reply" style="display: none;">Trả lời</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Bạn cần phải <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> hoặc <a style="color:blue" href="{{route('register.form')}}">Đăng ký</a> để tham gia bình luận.
