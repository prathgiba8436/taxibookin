...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Loại Blog</h6>
      <a href="{{route('post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm mới</a>
    </div>
    <div class="card-body">
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    ...
                    text: "Một khi xoá dữ liệu sẽ không thể khôi phuc!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
