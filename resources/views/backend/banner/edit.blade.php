...
@section('title','TAXI || Banner Edit')
    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}">
        ...
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">Tiểu đề <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            <option value="active" {{(($banner->status=='active') ? 'selected' : '')}}>Hiệu lực</option>
            <option value="inactive" {{(($banner->status=='inactive') ? 'selected' : '')}}>Hết hiệu lực</option>
          </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
